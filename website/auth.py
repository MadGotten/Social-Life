...
def signup():
    ...
    if form.validate_on_submit():
        ...
        if user_email:
            ...
            msg = Message(
                subject=f"Social Life - Confirm your account",
                html=render_template("auth/confirm_email.html", username=user.username ,confirm_url=confirm_url),
...
def resend_confirmation():
    ...
    msg = Message(
        subject=f"Social Life - Confirm your account",
        html=render_template("auth/confirm_email.html", username=current_user.username ,confirm_url=confirm_url),
