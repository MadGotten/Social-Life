...
class RegisterForm(FlaskForm):
    ...
    username = StringField(
        ...
        validators=[
            DataRequired(),
            Length(min=3, max=30, message="Username must be greater than 3 characters"),
            Regexp(r"^[a-zA-Z0-9]+$", message="Username must be alphanumeric."),
        ],
    ...
    firstname = StringField(
        ...
        validators=[
            DataRequired(),
            Length(min=2, max=100, message="First name must be greater than 2 characters"),
        ],
    ...
    lastname = StringField(
        ...
        validators=[
            DataRequired(),
            Length(min=2, max=100, message="Last name must be greater than 2 characters"),
        ],
